...
class app:
    ...
    def logPage(self):
        ...
        l1 = ttk.Label(root, text="2023/8/19 著手開發第一版(純文字版)")
        l1.pack(anchor=W)
        l2 = ttk.Label(root, text="2023/8/23 嘗試轉換成第二版(GUI版)")
        l2.pack(anchor=W)
        l3 = ttk.Label(root, text="2023/9/4 第一版的功能大致重現完畢")
        l3.pack(anchor=W)
        l4 = ttk.Label(root, text="2023/9/10 新增其他功能及補完所有馬娘的資料")
        l4.pack(anchor=W)
        l4 = ttk.Label(root, text="2023/9/21 新增 凱斯奇蹟/ケイエスミラクル")
        l4.pack(anchor=W)
